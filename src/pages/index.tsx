...
const aboutStats = [
  ...
  { label: "Technologies mastered", value: "1+" },
      ...
      <div ref={refScrollContainer}>
        ...
        >
          <div className={styles.intro}>
            ...
            >
              <Link href="mailto:rakesh123yo@gmail.com" passHref>
                <Button>
        ...
        <section id="about" data-scroll-section>
          ...
          >
            <h2 className="py-16  pb-2 text-3xl font-light leading-normal tracking-tighter text-foreground xl:text-[40px]">
              I&apos;m a BTech student at{" "}
              <span className="text-gradient">Parul University</span> in Vadodara, Gujarat, 
              currently in my 2nd year and expected to graduate in 2027. 
              I&apos;m passionate about programming and proficient in{" "}
              <span className="text-gradient">Python</span> and{" "}
              <span className="text-gradient">HTML</span>. 
              I enjoy building web applications and solving complex problems through code. 
              My focus is on creating efficient and user-friendly solutions while continuously 
                              ...
                              <div className="relative aspect-video w-full overflow-hidden rounded-t-md bg-primary">
                                <video
                                  ...
                                  onError={(e) => {
                                    ...
                                    fallback.src = project.fallbackImage;
